...
all_subjects = ['dj051418','dy051818','gl052818','he042718','hw111117','is060118','jd051818',
                'qh111717','rt022718','sw050818','tl111017','xl042618','yg042518','yq052218']
...
def make_vectors(subjdirs, scriptsdir, vector_file):
    ...
    for dir in subjdirs:
        os.chdir(dir)
        subprocess.call(['/Users/blevins/Desktop/cultsid/scripts/makeVec.py', vector_path])
...
if __name__ == '__main__':
    ...
    for output_dir, subjects in zip(['mid_tcs'],[s1]):
